...
Embed types: audio, video, search embeds, and external images also supported.
...
Callout aliases, nesting, and custom CSS callouts also supported.
...
Property types: text, number, date, checkbox, list. Tag syntax rules: letters, numbers (not first char), underscores, hyphens, forward slashes.
